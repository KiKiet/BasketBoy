System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Ball", Ball = (_dec = ccclass('Ball'), _dec2 = property(AudioSource), _dec3 = property(AudioClip), _dec(_class = (_class2 = (_temp = _class3 = class Ball extends Component {
        constructor(...args) {
          super(...args);

          _defineProperty(this, "isScore", false);

          _initializerDefineProperty(this, "sound", _descriptor, this);

          _initializerDefineProperty(this, "bounceSound", _descriptor2, this);

          _defineProperty(this, "cnt", 0);

          _defineProperty(this, "checkGoal", false);
        }
        ...
        static awakeRbAndShoot(force, shootPower) {
      ...
      }, _defineProperty(_class3, "score", 0), _defineProperty(_class3, "rb", void 0), _defineProperty(_class3, "ballPos", void 0), _defineProperty(_class3, "thisNode", void 0), _defineProperty(_class3, "anim", void 0), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "sound", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
